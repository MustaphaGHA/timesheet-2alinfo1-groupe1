...
public interface EmployeRepository extends CrudRepository<Employe, Integer>  {
	...
	@Query("SELECT e FROM Employe e WHERE e.email=:email and e.password=:psd")//NOSONAR
	public Employe getEmployeByEmailAndPassword(@Param("email")String login, @Param("psd")String psd);
