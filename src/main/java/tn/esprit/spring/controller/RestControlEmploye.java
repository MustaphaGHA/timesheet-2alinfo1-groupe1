...
import tn.esprit.spring.model.EmployeRequestModel;
...
public class RestControlEmploye {
	...
	@ResponseBody
	public Employe ajouterEmploye(@RequestBody EmployeRequestModel employee)
	{
		Employe employe = new Employe(employee);
	...
	@ResponseBody
	public int ajouterContrat(@RequestBody ContratRequestModel contratt) {
		Contrat contrat = new Contrat(contratt);
